...
using UnityEngine.InputSystem;
    ...
    public class Pathfinding
    {
		...
		public static List<Point> FindPath(Cell grid, Point startPos, Point targetPos, DistanceType distance = DistanceType.Euclidean, bool ignorePrices = false)
        {
            // find path
        ...
        private static List<Node> _ImpFindPath(Cell grid, Point startPos, Point targetPos, DistanceType distance = DistanceType.Euclidean, bool ignorePrices = false)
        {
        ...
        private static List<Node> RetracePath(Cell grid, Node startNode, Node endNode)
        {
